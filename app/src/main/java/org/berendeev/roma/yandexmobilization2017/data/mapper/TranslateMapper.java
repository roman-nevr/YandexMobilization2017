...
public class TranslateMapper {
    public static Word map(TranslationQuery query, Translation translation){
        String[] langs = translation.lang.split("-");
        return Word.create(query.text(), translation.translation.get(0), langs[0], langs[1], false);
    }
}
